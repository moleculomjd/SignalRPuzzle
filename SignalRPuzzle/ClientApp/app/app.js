...
var puzzleHub = $.connection.puzzleHub,
    //$shape = $("#shape"),
...
puzzleHub.client.updatePiece = function (pieces) {
...
function updateServerModel() {
    ...
    for (var i = 0; i < movedPieces.length; i++) {
        puzzleHub.server.updatePiece(movedPieces[i]);
        movedPieces[i].moved = false;
    }
}

function broadcastShuffledPiecesArray() {
    puzzleHub.server.loadPieces(_pieces);
}
